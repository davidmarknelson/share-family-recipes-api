...
router.route('/signup').post(parse.checkPasswordValidity, parse.trimBodyEmail, users.signup);
...
router.route('/update').put(auth.isAuthenticated, parse.trimBodyEmail, users.update);
